      ...
      <main className="sabha-main">
        <section className="sabha-hero">
          <div className="sabha-hero-content">
            <p className="sabha-sanskrit-tagline">सभायां युक्तिर्जायते ॥</p>
            <h1>
              Sabha – <span className="sabha-highlight">the AI Assembly</span>
            </h1>
            <p className="sabha-hero-subtitle">
              A modern डिजिटल सभा where models discuss, debate, and reason like a
              council of thinkers. Orchestrate multiple LLMs, align perspectives,
            ...
            <p className="sabha-hero-caption">
              Inspired by the ancient भारतीय सभासद् tradition of collective
              deliberation, reimagined for autonomous AI systems.
            </p>
          </div>
          ...
          <div className="sabha-hero-panel">
            ...
            <div className="sabha-hero-panel-card">
              ...
              <p className="sabha-panel-body">
                ...
                arguments, counter-arguments, and final consensus—fully
                traceable.
              </p>
            </div>
          </div>
        ...
        <section id="about" className="sabha-section sabha-section-alt">
          ...
          <div className="sabha-grid-3">
            <div className="sabha-card">
              ...
              <p>
                Orchestrate multiple foundation and specialized models in
                structured dialogue. Each plays a भूमिका (role): critic,
                explainer, planner, or judge.
              </p>
            </div>
            <div className="sabha-card">
              <h3>Structured तर्क</h3>
              <p>
                Capture arguments as trees, not just text. Sabha keeps the
                “reasoning trail” visible, auditable, and reusable across
                sessions.
              </p>
            </div>
            <div className="sabha-card">
              ...
              <p>
                Define aggregation rules: voting, weighted expertise, or
                human‑in‑the‑loop. Sabha helps models converge without losing
                dissenting views.
              </p>
            </div>
          </div>
        ...
        <section id="architecture" className="sabha-section">
          <div className="sabha-section-header">
            ...
            <p className="sabha-section-subtitle">
              A layered design inspired by traditional ritual: invocation,
              offering, deliberation, and resolution.
            </p>
          </div>
          ...
          <div className="sabha-arch-layout">
            <div className="sabha-arch-column">
              <div className="sabha-arch-step">
                ...
                <h3>Orchestrator</h3>
                <p>
                  Receives the user’s प्रश्न (query), chooses participants, and
                  sets the protocol for dialogue.
                </p>
              </div>
              <div className="sabha-arch-step">
            ...
            <div className="sabha-arch-column">
              <div className="sabha-arch-step">
                ...
                <p>
                  All rationales, objections, and supporting evidence are stored
                  in a structured ledger for replay and analysis.
                </p>
              </div>
              <div className="sabha-arch-step">
        ...
        <section id="use-cases" className="sabha-section sabha-section-alt">
          <div className="sabha-section-header">
            ...
            <p className="sabha-section-subtitle">
              Any space that benefits from multiple perspectives and rigorous
              reasoning.
            </p>
          </div>
          ...
          <div className="sabha-grid-3">
            <div className="sabha-card">
              ...
              <p>
                Run safety, policy, and red‑team models together. Capture
                disagreements and automatically escalate edge cases to humans.
              </p>
            </div>
            <div className="sabha-card">
              <h3>Research & Analysis</h3>
              <p>
                Assemble domain‑specific experts that argue for and against
                hypotheses, then summarize the distilled consensus.
              </p>
            </div>
            <div className="sabha-card">
              <h3>Product Decisions</h3>
              <p>
                Use models tuned for UX, engineering, legal, and business to
        ...
        <section id="contact" className="sabha-section sabha-footer-cta">
          <div className="sabha-section-header">
            ...
            <p className="sabha-section-subtitle">
              Bring multi‑model assemblies into your stack. Early collaborators,
              reach out:
            </p>
          </div>
          <form
          ...
          >
            ...
            <p className="sabha-contact-note">
              We’ll share design notes, architecture diagrams, and early alpha
              access.
            </p>
          </form>
        </section>
