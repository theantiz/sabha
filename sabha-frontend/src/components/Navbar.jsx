...
export default function Navbar() {
  ...
  return (
    <header className="mx-auto mb-9 flex max-w-[1120px] flex-wrap items-center justify-between gap-4 rounded-full border border-[rgba(130,92,57,.22)] bg-[rgba(255,253,248,.88)] px-4 py-3 shadow-[0_12px_32px_rgba(75,43,20,.12),inset_0_1px_0_rgba(255,255,255,.5)] backdrop-blur-xl">
      ...
      {open ? (
        <div className="mt-3 flex w-full flex-col gap-2 rounded-3xl border border-[rgba(130,92,57,.22)] bg-[rgba(255,252,247,.96)] p-3 shadow-[0_16px_32px_rgba(75,43,20,.12)] sm:hidden">
          {navLinks.map(([href, label]) => (
            <a
              key={href}
              href={href}
